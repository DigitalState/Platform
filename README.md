...
At this point, you have the SDK container running locally with Ansible pre-installed and ready to accept commands. Next step would be to deploy a local [lab environment](sdk/documentation/lab/index.md).
